...
export const AngleDown: React.FC<Props> = ({ className }) => {
	return (
		<svg
			className={className || 'w-4 h-4 text-gray-800'}
			aria-hidden="true"
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
			viewBox="0 0 14 8"
...
export const AngleUp: React.FC<Props> = ({ className }) => {
	return (
		<svg
			className={className || 'w-4 h-4 text-gray-800'}
			aria-hidden="true"
