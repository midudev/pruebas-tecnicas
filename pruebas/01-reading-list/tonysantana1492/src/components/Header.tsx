...
export const Header = () => {
  const { maxPages, favorites, availablesBooks } = useBook()
		...
		<header className="flex flex-col gap-4 w-full">
			<div className="flex flex-col lg:flex-row gap-4 justify-between items-start w-full">
				<div className="flex justify-between items-center w-full">
					<h2 className="font-bold text-2xl text-left">Available Books {availablesBooks.length}</h2>
					<button role='open-button' className="relative flex lg:hidden" onClick={onOpen}>
						<OpenBook />
