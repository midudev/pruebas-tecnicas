...
function ListBooks() {
	 ...
	 */
	const { books, setBooks, setReadingList, readingList } =
	...
	return (
		<div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 ">
			...
			<div className=" mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 ">
				{books.map(({ book }) => {
					const { ISBN, title, year, synopsis, cover } = book;
					return (
						<div key={ISBN} className="shadow-xl">
							...
							<div className="flex justify-center items-center p-4 mt-2 ">
								<button
									onClick={() => addToRedingList(book)}
									className="bg-cyan-400 p-4 rounded-md hover:bg-cyan-300 flex justify-center items-center"
								>
