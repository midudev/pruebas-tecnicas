...
export default function Navigation(): JSX.Element {
  ...
  const { colorMode, setColorMode, wWidth, readList } = useContext(GlobalContext)
  ...
  return ( 
    <div>
      ...
      <main id="content" className={`${colorMode}`}>        
        <div className={itemSelected === 'booklist' ? 'selected' : 'unselected'}>
          <BookList 
            setItemSelected={setItemSelected}
          ></BookList> 
        </div>
        <div className={itemSelected === 'readlist' ? 'selected' : 'unselected'}>
        <ReadList 
          setItemSelected={setItemSelected}
        ></ReadList> 
        </div>
        <div className={itemSelected === 'about' ? 'selected' : 'unselected'}>
          <About></About> 
        </div>
      </main>
    </div>
