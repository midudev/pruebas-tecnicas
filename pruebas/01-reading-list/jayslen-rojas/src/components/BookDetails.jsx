...
function LiDetails ({ title, info }) {
  return (
    <li>
      ...
      <p className='max-w-[250px]'>{info}</p>
    </li>
  )
}
...
export function BookDetails ({ book, closePopUp }) {
  return (
    <div className="fixed bg-black top-0 left-0 grid place-content-center bg-opacity-50 w-screen h-screen animate-fade animate-once animate-duration-[400ms] animate-ease-in-out">
