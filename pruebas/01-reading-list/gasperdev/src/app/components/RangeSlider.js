...
export default function RangeSlider() {
  ...
  const { pagesAllBooks, setPagesAllBooks, maxPagesCount } = useBooksData();
  ...
  return (
    <div className="flex w-full text-sm font-normal text-gray-900 rounded-lg bg-slate-200 dark:bg-gray-900 dark:hover:bg-gray-800 dark:text-white ">
      ...
      <input
        ...
        className="w-full h-2 gap-10 mt-4 text-gray-900 bg-white rounded-lg appearance-none cursor-pointertext-sm"
      />
