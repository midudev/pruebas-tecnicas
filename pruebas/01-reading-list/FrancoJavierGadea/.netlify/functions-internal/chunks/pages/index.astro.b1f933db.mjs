import { c as createAstro, a as createComponent, r as renderTemplate, e as renderComponent, m as maybeRenderHead, b as addAttribute } from '../astro.e69f02c8.mjs';
import 'html-escaper';
import { $ as $$RootLayout, S as SaveBook, B as BooksFilters } from './_page_.astro.5a085c22.mjs';
/* empty css                           */import { s as searchBooks } from './_ISBN_.js.e3afcb43.mjs';

const $$Astro$2 = createAstro();
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$Index$1;
  return renderTemplate`${renderComponent($$result, "RootLayout", $$RootLayout, { "title": "Libros" }, { "default": ($$result2) => renderTemplate`

	${maybeRenderHead()}<h1>Index</h1>
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "RootLayout", $$RootLayout, { "title": "Resultados de la busqueda", "searchPlaceholder": search, "class": "astro-SQEKDMOK" }, { "default": ($$result2) => renderTemplate`
    ...
    ${renderComponent($$result2, "BooksFilters", BooksFilters, { "client:load": true, "path": "/search", "pages": filters.pages, "genre": filters.genre, "queryParams": { search }, "total": result.length, "client:component-hydration": "load", "client:component-path": "H:/PROGRAMACION/pruebas_tecnicas_midudev/pruebas/01-reading-list/FrancoJavierGadea/src/components/react/BooksFilters/BooksFilters", "client:component-export": "default", "class": "astro-SQEKDMOK" })}

    ${maybeRenderHead()}<div class="Books-container astro-SQEKDMOK">
        ${result.map(({ book }) => {
...
` })}`;
}, "H:/PROGRAMACION/pruebas_tecnicas_midudev/pruebas/01-reading-list/FrancoJavierGadea/src/pages/search/index.astro", void 0);
