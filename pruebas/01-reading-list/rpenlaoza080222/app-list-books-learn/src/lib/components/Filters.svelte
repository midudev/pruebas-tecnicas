...
<div class="filters mb-4 bg-gray-900">
  <div class="filters-inputs w-full">
    <div style="display: flex;align-items:center;gap:20px;justify-content:space-between; width:100%">
      ...
      <div class="flex gap-[10px] items-center w-full">
        ...
        <select
          ...
          class="w-sm bg-gray-700 text-lg border border-gray-300 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        >
    ...
    >
      <span
        class="relative px-5 py-2.5 text-white transition-all ease-in duration-75 bg-gray-700 dark:bg-white rounded-md group-hover:bg-opacity-0"
      >
