...
const PageFilter = (): ReactElement => {
  ...
  return (
    <div className='flex flex-col gap-1'>
      ...
      <span className='font-medium'>Filtrar por páginas: {filters.pages}</span>
      <label className='flex justify-center items-center' htmlFor='pageFilter' title={`Hasta ${filters.pages || 'cualquier'} páginas`}>
      ...
      <input
        ...
        className='accent-green-500 w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer'
      />
