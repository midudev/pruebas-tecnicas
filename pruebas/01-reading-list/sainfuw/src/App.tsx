...
export default function App() {
  return (
    <main className="flex flex-col h-screen max-w-6xl gap-12 p-8 mx-auto">
      <header className="p-5 text-3xl text-center text-white bg-blue-500">
        Biblioteca Online
      </header>
      ...
      <footer className="p-5 text-center text-white bg-blue-500">
        Todos los derechos reservados, sainfuw 2023
      </footer>
      <FrameExample />
    </main>
  )
