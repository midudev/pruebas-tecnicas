    ...
    return (
        <form>
            <fieldset className='flex flex-col md:flex-row justify-start gap-10'>
                ...
                <div className='flex flex-col gap-2'>
                    <label htmlFor='freesearch'>Búsqueda por nombre</label>
