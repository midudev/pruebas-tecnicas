export const BOOK_ICON = (width, height, className) =>
...
export const CLOSE_MARK = (width, height, className) =>
  <svg xmlns='http://www.w3.org/2000/svg' width={width} height={height} className={className} viewBox='0 -960 960 960'>
