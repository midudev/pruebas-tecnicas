...
import store from "../store"; // Importa tu store desde '../store.js'
import App from "../App";
...
describe("Test Lista Libros", () => {
  test("Tes basico de prueba ", () => {
    expect(1 + 1).toBe(2);
  });
});

describe("Renderiza correctamente", () => {
  let mockStore;
  let store;
  ...
  test("Tienen que existir 13 libros en disponibles", async () => {
    const disponibles = [
      {
    ...
    // Obtiene el resultado del renderizado como una cadena de texto HTML
    const renderedHTML = container.innerHTML;
    // console.log(renderedHTML);
    expect(screen.getByText("13 libros disponibles")).toBeDefined()
  });
});
