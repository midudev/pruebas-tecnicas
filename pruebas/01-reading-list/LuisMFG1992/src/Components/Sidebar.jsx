...
const Sidebar = ({ handelSidabar, readingList }) => {
  return (
    <div className="inline-flex">
      ...
      <div className="flex flex-col gap-4 w-full xs:w-[70%] xs:min-w-[350px] sm:w-[50%] sm:min-w-[400px] lg:w-[50%] max-w-[600px] bg-gray-001 z-10 min-h-screen fixed top-0 right-0 p-4">
