  ...
  <header class="header">
    <nav class="navbar">
      ...
      <ul class="navbar__list">
        <li>
          <a class="navbar__link" href="https://github.com/jhobahego" target="_blank">
            <svg stroke="white" fill="white" stroke-width="0" viewBox="0 0 496 512" class="navbar__icon" height="1.8em"
