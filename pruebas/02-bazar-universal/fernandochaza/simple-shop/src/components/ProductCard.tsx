...
const ProductCard = ({ product }: { product: Product }) => {
  ...
  return (
    <article className="bg-slate-50 grid grid-cols-2 auto-rows-min gap-y-2 gap-x-2 relative w-[316px] h-[248px] mx-auto px-4 py-4 shadow-[5px_5px_20px_#b0b2b3,-5px_-5px_20px_#ffffff] rounded-3xl">
      <h2 className="col-span-full text-center text-lg font-extrabold line-clamp-1 overflow-hidden">
        {capitalizedTitle}
      </h2>
      ...
      <p className="my-4 col-start-2 row-start-3">$ {price}</p>
